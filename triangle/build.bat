...
set INCLUDES=/I "..\third_party\glew-2.1.0\include" /I "..\third_party\glfw-3.4\include"
set LIB_PATH_GLFW=/LIBPATH:"..\third_party\glfw-3.4\lib-vc2022"
...
set DLL_PATH_GLFW="third_party\glfw-3.4\lib-vc2022\glfw3.dll"
set SRC="*.c??"

@echo on

cl %CFLAGS% %SRC% %INCLUDES% /link %LFLAGS% %LIBS% /OUT:"triangle.exe" 
